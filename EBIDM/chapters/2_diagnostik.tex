...
\monofig{width=0.4\textwidth}{Roentgen.JPG}{Röntgenaufnahme einer linken Hand: Wikimedia-Commons (CC BY-SA 3.0) \cite{roentgenbild}}{fig:roentgen}
...
\monofig{width=0.6\textwidth}{ct.JPG}{Computertomograph: Wikimedia-Commons (CC BY-SA 3.0) \cite{ct}}{fig:ct}
